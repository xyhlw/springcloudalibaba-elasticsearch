package com.xy.cloud.search.constants;
...
public interface Constants {
	...
	Integer ES_DATA_TYPE_PARTICIPLES = 0;

	Integer ES_DATA_TYPE = 1;

	String MANUAL_ES_CHN = "1";

	String MANUAL_ES_ENG = "2";

	String ES_ENTITY_TITLE = "title";
	...
	String ES_MANUALTYPE = "manualType";

	String ES_USAGESCENARIOSTYPE = "usageScenariosType";

	String ES_PARENTID = "parentId";


	String ES_CLOER_HGITH_START = "<span style='color: red'>"  ;

	String ES_CLOER_HGITH_STOP = "</span>"  ;
